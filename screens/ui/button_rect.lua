...
function button_rect.make_button(template_node, opts)
  ...
  local background_colors = {
    [Button.STATE_DEFAULT] = color,
    [Button.STATE_HOVER] = colors.bright_gold,
    [Button.STATE_PRESSED] = pressed_color or color,
    [Button.STATE_DISABLED] = colors.gray(0.0)
  }

  local label_colors = {
    [Button.STATE_DEFAULT] = label_color,
    [Button.STATE_HOVER] = colors.white,
    [Button.STATE_PRESSED] = colors.gray(0.5),
    [Button.STATE_DISABLED] = colors.gray(0.1)
  }
